...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        std::string strUsage = _("Fastcoin Core Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n";
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  fastcoind [options]                     " + _("Start Fastocin Core Daemon") + "\n";
    ...
    try
    {
        ...
        if (fCommandLine)
        {
            fprintf(stderr, "Error: There is no RPC client functionality in fastcoind anymore. Use the fastcoin-cli utility instead.\n");
            exit(1);
        }
#ifndef WIN32
